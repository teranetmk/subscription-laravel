    ...
    public function render()
    {
        return <<<'blade'
            @if (session('status') === 'password-updated')
                <span class="basis-alert alert alert-success">
            ...
            @elseif(session('status'))
                <span class="basis-alert alert alert-info">
            ...
            @if(session()->has('danger'))
                <span class="basis-alert alert alert-danger">
            ...
            @if(session()->has('warning'))
                <span class="basis-alert alert alert-warning">
